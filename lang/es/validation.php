...
return [
    ...
    | convenția "attribute.rule" pentru a denumi liniile. Acest lucru face ușor
    | specificarea unui mesaj de limbă personalizat pentru o regulă de atribut dată.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Următoarele linii de limbă sunt folosite pentru a schimba atributele noastre marcă
    | cu ceva mai ușor de citit, cum ar fi "Adresa de e-mail" în loc de "email". Acest lucru
    | ne ajută doar să facem mesajul nostru mai expresiv.
    |
    */
